...
const QUESTIONS = [
  {
    ...
    type: "custom",
    kind: "molkky-start",
    question: "Quel score avez-vous atteint au Mölkky coopératif ?",
    instructions:
      "Indiquez votre score final puis cochez les objectifs annexes validés. L’objectif principal reste d’atteindre exactement 50 (si dépassement → retour à 25).",
    targetScore: 50,
    points: 1000,
    objectives: [
    ...
    answerDisplay: "Bilan Mölkky enregistré.",
    nextBlock: {
  ...
  },
  {
    ...
    nextBlock: {
      ...
      label:
        "Commencez le QCM Henryesque : évitez la vraie réponse, départ à 800 points, -1 point par seconde et -10 si vous cliquez sur la vraie.",
    },
  },
  {
    id: 12,
    ...
    options: ["La guerre de Chypre", "La guerre de Crimée", "La guerre du Liban", "La guerre des Malouines"],
  ...
  },
  {
    ...
    options: [
      ...
      "Un VTT et une gourde isotherme Ultra",
      "Un vélo gravel et une gourde en alu",
      "Un vélo de route et une flask d’Ultra",
    ],
    answerDisplay: "Un vélo et une bouteille d’Ultra comme gourde",
    answer: "Un vélo et une bouteille d’Ultra comme gourde",
    points: 0,
  },
  {
    id: 14,
    ...
    options: ["Rue planche au pêcheur", "Rue de la Planche", "Rue des Pêcheurs", "Rue du Vieux Moulin"],
  ...
  },
  {
    ...
    options: ["Copilot", "Copilot Studio", "GitHub Spark", "ChatGPT Enterprise"],
    answer: "Copilot",
    points: 0,
  },
  {
    ...
    options: ["Albanie", "Monténégro", "Croatie du Sud", "Macédoine du Nord"],
    answer: "Albanie",
    points: 0,
  },
  {
    ...
    options: ["Badminton, paddle", "Badminton, squash", "Padel, tennis", "Badminton, pickleball"],
  ...
  },
  {
    ...
    options: ["Golf", "Golf GTI", "Polo", "Golf break"],
    answerDisplay: "Golf",
    answer: "Golf",
    points: 0,
  },
  ...
  },
  {
    ...
    options: ["Iran", "Turquie orientale", "Géorgie", "Arménie"],
    answer: "Iran",
    points: 0,
  },
  {
    ...
    options: ["Saint Jacques", "Saint-Jacob", "Saint-Jacques-de-Compostelle", "École Jacques"],
  ...
  },
  {
    ...
    options: ["La Réunion", "Maurice", "Guadeloupe", "Martinique"],
  ...
  },
  {
    ...
    options: ["Courcelles", "Cour-sur-Heure", "Couillet", "Courrière"],
  ...
  },
  {
    ...
    options: ["2ème", "2e", "1er étage", "dernier étage"],
    answer: "2ème",
    points: 0,
  },
  {
